...
class TitleDesc2MediaType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\Template\TitleDesc2Media',
                'template'   => '',
                'templates'  => ''
            )
        );
    ...
    {
        return 'admin_page_template_title_desc2_media';
    }
}
