...
class TitleDesc2MediaBlock2Type extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(
            array(
                'data_class' => 'Bigfoot\Bundle\ContentBundle\Entity\Page\Template\TitleDesc2MediaBlock2',
                'template'   => '',
                'templates'  => ''
            )
        );
    ...
    {
        return 'admin_page_template_title_desc2_media_block2';
    }
}
